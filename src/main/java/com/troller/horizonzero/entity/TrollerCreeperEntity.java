package com.troller.horizonzero.entity;
...
public class TrollerCreeperEntity extends Monster {
	public TrollerCreeperEntity(EntityType<TrollerCreeperEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("horizon_zero:troller_creeper_trolling"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.creeper.hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.creeper.death"));
	}
	...
	public boolean hurtServer(ServerLevel level, DamageSource damagesource, float amount) {
		...
		TrollerCreeperHurtProcedureProcedure.execute(world, x, y, z, entity);
